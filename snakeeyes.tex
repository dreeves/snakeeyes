...
The key is that as long as the probability of being chosen isn't exactly zero, there's no division-by-zero problem like before.
...
\item Your probability of being $n$th in the queue is 99.9999\% as much as your probability of being chosen $n-1$st
\end{itemize}
